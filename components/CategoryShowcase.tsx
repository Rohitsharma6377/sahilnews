...
function Tile({ a, tall = false }: { a: ArticleLite; tall?: boolean }) {
  return (
    ...
    >
      {/* gradient hover ring */}
      <span className="pointer-events-none absolute inset-0 rounded-2xl bg-gradient-to-br from-emerald-400/20 to-sky-400/20 opacity-0 transition group-hover:opacity-100" />
