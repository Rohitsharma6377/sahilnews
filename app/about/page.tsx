...
export const metadata = {
  title: 'About • SahilNews',
  description:
    'About SahilNews — a modern news & blogs site built with Next.js.',
}
...
export default function AboutPage() {
  return (
    <>
      <Header />
      <main className="bg-gradient-to-b from-sky-50 to-emerald-50 dark:from-slate-900 dark:to-slate-800">
        <section className="container py-14">
          <div className="max-w-3xl">
            <h1 className="font-heading text-4xl">About SahilNews</h1>
            <p className="mt-4 text-slate-700 dark:text-slate-300">
              SahilNews is a modern, fast, and elegant news experience. We
            ...
            <div className="mt-10">
              ...
              <p className="mt-2 text-slate-700 dark:text-slate-300">
                ...
                <span className="font-medium">hello@SahilNews.dev</span>.
              </p>
            </div>
          </div>
        </section>
